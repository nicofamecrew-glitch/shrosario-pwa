  ...
  return (
    <main className={page}>
      ...
      <p className={`mt-1 text-sm ${muted}`}>
        Tema, notificaciones e instalación.
      </p>
        ...
        <div className={card}>
          <div className="p-4">
            ...
            <div
              className={`mt-1 text-sm ${muted}`}
            >
              Recibí avisos de pago aprobado,
              pedidos y novedades.
            </div>

            <div
              className={`mt-2 text-xs ${muted2}`}
            >
        ...
        <div className={card}>
          <div className="p-4">
            ...
            <div
              className={`mt-1 text-sm ${muted}`}
            >
              Instalá SH Rosario para acceder
              más rápido desde tu pantalla de
              inicio.
            </div>
